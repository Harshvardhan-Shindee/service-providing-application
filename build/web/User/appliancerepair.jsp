...
<%
    ...
    List<Service> services = ServiceDAO.getServicesByCategory("Appliance repair & service");
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <p style="text-align:center; width: 100%;">No Appliance repair services are available at the moment.</p>
            <%
                }
            %>
        </div>
