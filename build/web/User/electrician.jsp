...
<%
    ...
    List<Service> services = ServiceDAO.getServicesByCategory("Electrician");
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <p style="text-align:center; width: 100%;">No Electrician  services available at the moment.</p>
            <%
                }
            %>
        </div>
