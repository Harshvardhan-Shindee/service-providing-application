...
<%
    ...
    List<Service> services = ServiceDAO.getServicesByCategory("House Cleaning");
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <p style="text-align:center; width: 100%;">No house cleaning services available at the moment.</p>
            <%
                }
            %>
        </div>
