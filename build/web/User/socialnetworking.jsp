...
<%
    ...
    List<Service> services = ServiceDAO.getServicesByCategory("Social Networking");
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <p style="text-align:center; width: 100%;">No Social Networking services available at the moment.</p>
            <%
                }
            %>
        </div>
