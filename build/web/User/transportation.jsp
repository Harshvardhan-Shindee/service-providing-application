...
<%
    ...
    List<Service> services = ServiceDAO.getServicesByCategory("Transportation");
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <p style="text-align:center; width: 100%;">No Transportation services available at the moment.</p>
            <%
                }
            %>
        </div>
