    ...
    <nav class="navbar">
        ...
        <div class="nav-right">
            <ul class="nav-links">
                ...
                <li><a href="admin_providers.jsp">Providers</a></li>

                <li>
                    <button onclick="toggleDropdown('workDropdown')">Work Requests</button>
                    <div id="workDropdown" class="dropdown-content">
                        <a href="admin_pending_requests.jsp">Pending Requests</a>
                        <a href="admin_completed_requests.jsp">Completed Requests</a>
                    </div>
                </li>
